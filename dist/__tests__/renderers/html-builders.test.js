...
import { buildChartHtml, getSupportedHtmlPatterns, isHtmlPatternSupported, buildHtml, } from '../../src/renderers/html/index.js';
...
function makeSpec(pattern, data, overrides) {
    return {
        pattern,
        title: `Test ${pattern}`,
        data,
...
describe('HTML Renderer Index', () => {
    ...
    it('buildChartHtml handles null spec', () => {
        const html = buildChartHtml(null);
...
describe('Individual HTML builders', () => {
    it.each(builderSpecs.map(s => [s.pattern, s]))('%s produces valid HTML', (_name, { pattern, data, overrides, extraChecks }) => {
...
//# sourceMappingURL=html-builders.test.js.map
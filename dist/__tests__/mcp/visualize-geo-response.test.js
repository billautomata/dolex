...
function makeSelectPatterns() {
    return (input) => {
        ...
        if (input.forcePattern)
            opts.forcePattern = input.forcePattern;
        ...
        return selectPattern(input.data, input.columns, input.intent, opts);
    };
}
...
//# sourceMappingURL=visualize-geo-response.test.js.map
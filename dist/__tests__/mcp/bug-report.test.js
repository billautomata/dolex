...
import { OperationLog, extractDslStructure, operationLog, } from '../../src/mcp/tools/operation-log.js';
import { anonymizeColumns, sanitizeSpecConfig, sanitizeError, handleReportBug, } from '../../src/mcp/tools/bug-report.js';
...
describe('OperationLog', () => {
    ...
    function entry(toolName, success = true) {
        return {
            toolName,
            timestamp: Date.now(),
            durationMs: 42,

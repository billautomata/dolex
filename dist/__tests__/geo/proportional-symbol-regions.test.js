...
describe('proportional-symbol region wiring', () => {
    it('generates spec with explicit geoRegion', () => {
        ...
        const spec = proportionalSymbolPattern.generateSpec(data, ['city', 'pop'], { geoRegion: 'JP' });
    ...
    it('generates spec with US auto-detection', () => {
        ...
        const spec = proportionalSymbolPattern.generateSpec(data, ['city', 'value'], { _intent: 'show US state data on a map' });
    ...
    it('spreads regionConfig into spec.config', () => {
        ...
        const spec = proportionalSymbolPattern.generateSpec(data, ['region', 'value'], { geoRegion: 'CN' });
...
//# sourceMappingURL=proportional-symbol-regions.test.js.map